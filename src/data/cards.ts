...
export const CARD_DB: CardDefinition[] = [
  ...
  },
  {
    ...
    stats: { hp: 20, maxHp: 20, atk: 2, def: 2, rarity: 1, aggression: 10, strength: 1,
...

  {
    ...
    cost: cost(1), upkeep: 0,
    emoji: '👾',
    description: '【彩蛋】基因突变的神秘生物，样貌十分丑陋。',
  ...
  },
  {
    ...
    cost: cost(2), upkeep: 0,
    emoji: '🌀',
    description: '【彩蛋】混沌能量孕育的怪物，侵略性极强。',
  ...
  },
  {
    ...
    cost: cost(3), upkeep: 0,
    emoji: '🕸️',
    description: '【彩蛋】深渊中最强的存在，通常是一片深渊的主宰。',
    stats: { hp: 400, maxHp: 400, atk: 70, def: 35, rarity: 20, aggression: 2, strength: 25,
  ...
  },
  {
    ...
    cost: cost(4), upkeep: 0,
    emoji: '🌟',
    description: '【彩蛋】远古时代的神话生物，力量媲美神明，性情较为温和。',
    stats: { hp: 800, maxHp: 800, atk: 120, def: 75, rarity: 35, aggression: 5, strength: 45,
  ...
  },
  {
    ...
    cost: cost(5), upkeep: 0,
    emoji: '💥',
    description: '【彩蛋】存在本身即是终结，据说它的出现预示着文明的毁灭。',
